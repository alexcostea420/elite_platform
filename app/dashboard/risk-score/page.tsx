      ...
      <main className="pb-16 pt-24 md:pt-28">
        <Container>
          ...
          <section className="mb-8 grid gap-4 md:grid-cols-4">
            <article className="panel px-5 py-6 text-center md:col-span-1">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Scor Risc</p>
              <h3 className={`mt-3 font-display text-6xl font-bold ${getScoreColor(riskScore.score)}`}>
                {riskScore.score}
              </h3>
              <p className="mt-2 text-sm text-slate-400">{getScoreLabel(riskScore.score)}</p>
            </article>
            <article className="panel px-5 py-6 text-center md:col-span-1">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">Decizie</p>
              <div className="mt-3 flex justify-center">
                <span
                  className={`rounded-full border px-5 py-2 text-lg font-bold ${getDecisionColor(riskScore.decision)}`}
                >
                  {riskScore.decision}
                </span>
              </div>
            ...
            <article className="panel px-5 py-6 md:col-span-1">
              <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500">BTC Preț</p>
              <h3 className="mt-3 text-2xl font-bold text-white">${formatNumber(riskScore.btc_price_live)}</h3>
              <p className="mt-2 text-sm text-slate-400">ATH: ${formatNumber(riskScore.btc_ath)}</p>
            ...
            <article className="panel px-5 py-6 md:col-span-1">
              ...
              <h3
                className={`mt-3 text-2xl font-bold ${riskScore.fear_greed.value <= 25 ? "text-red-400" : riskScore.fear_greed.value <= 50 ? "text-orange-400" : riskScore.fear_greed.value <= 75 ? "text-yellow-400" : "text-green-400"}`}
              >
