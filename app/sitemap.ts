...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: getAbsoluteRouteUrl("/sesiuni", "app"),
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.85,
    },
    ...
    {
      url: getAbsoluteRouteUrl("/blog/ciclul-bitcoin-2026"),
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.6,
    },
    {
      url: getAbsoluteRouteUrl("/termeni", "app"),
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.3,
    },
    {
      url: getAbsoluteRouteUrl("/confidentialitate", "app"),
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.3,
    },
    {
      url: getAbsoluteRouteUrl("/rambursare", "app"),
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.3,
    },
