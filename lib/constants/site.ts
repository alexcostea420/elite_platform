...
export const dashboardNavGroups = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/news", label: "Știri", icon: "📰" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/crypto", label: "Crypto", icon: "₿" },
      { href: "/dashboard/risk-score", label: "Risk Score", icon: "🎯" },
      { href: "/dashboard/macro", label: "Macro Economy", icon: "🏛️" },
      { href: "/dashboard/pivots", label: "Pivoți de Timp", icon: "🔮" },
      { href: "/dashboard/portfolio", label: "Portofoliu", icon: "💼" },
    ],
  },
  {
    label: "Trading",
    items: [
      ...
      { href: "/tools/journal", label: "Jurnal + Calculator", icon: "📓" },
      { href: "/tools/whale-tracker", label: "Whale Tracker", icon: "🐋" },
      { href: "/tools/liquidation-map", label: "Liquidation Map", icon: "🎯" },
...
export const footerLinks = {
  ...
  legal: [
    ...
    { href: "/disclaimer", label: "Disclaimer și Risc" },
