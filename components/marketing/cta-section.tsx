    ...
    <section className="bg-gradient-to-br from-surface-graphite via-crypto-dark to-black px-4 py-20">
      <Container className="max-w-4xl text-center">
        <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl md:text-5xl">
          Gata sa faci primul pas spre <span className="gradient-text">trading consistent</span>?
        </h2>
        ...
        <p className="mt-6 text-sm text-slate-500">Fara card de credit. Cont activ in 2 minute.</p>
      </Container>
    </section>
  );
}
